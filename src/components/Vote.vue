  ...
  <div>
    ...
    <div v-show="selectedTab === `Grid`">
      <div class="Vote-block-grid">
        <div v-for="team in teamMembers" :key="team.id" class="Vote-block-grid-member" role="vote">
          ...
          <button class="Vote-block-grid-button" @click="addToVote(team.id)">Like ❤️</button>
          <button
    ...
    <div v-show="selectedTab === `List`">
      <div class="Vote-block-list">
        <div v-for="team in teamMembers" :key="team.id" class="Vote-block-list-member" role="vote">
          ...
          <div>
            ...
            <button class="Vote-block-list-button" @click="addToVote(team.id)">Like ❤️</button>
            <button
...
.Vote-block {
  ...
  &-list {
    ...
    &-member {
      ...
      transition: all 0.2s;
      &:hover {
        background-color: rgb(125, 233, 245);
      }
    }
    &-button {
      cursor: pointer;
